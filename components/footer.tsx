...
const footerLinks = {
  services: [
    ...
    { label: "SEVIS Payment", href: "/services/sevis-payment" },
    { label: "Credential Evaluation", href: "/services/credential-evaluation" },
  ],
  company: [
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div>
                <span className="font-serif text-2xl font-bold text-primary-foreground">SAMOP Consulting</span>
                <p className="text-sm text-primary-foreground/80">Your Gateway to Global Education</p>
              </div>
            </Link>
